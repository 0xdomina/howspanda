...
const Redeemable = model.define("redeemable", {
  ...
  title: model.text(),
  design_variant: model.text().default("sunset"),
  background_image: model.text().nullable(),
  accent_color: model.text().nullable(),
  message: model.text().nullable(),
  event_name: model.text().nullable(),
  venue_name: model.text().nullable(),
  venue_address: model.text().nullable(),
  event_starts_at: model.dateTime().nullable(),
  event_ends_at: model.dateTime().nullable(),
