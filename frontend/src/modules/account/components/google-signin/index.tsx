  ...
  return (
    <div className="w-full">
      <div className="my-4 flex items-center gap-3">
        <div className="h-px flex-1 bg-ink-hairline" />
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-medium border border-ink-strong px-4 py-2.5 text-sm font-medium text-ink hover:bg-paper-tinted"
      >
